...
void HAL_ADC_MspInit(ADC_HandleTypeDef* hadc)
{
  ...
  /* USER CODE END ADC1_MspInit 0 */
    ...
    PA5     ------> ADC1_IN10
    */
    GPIO_InitStruct.Pin = I_STATOR_Pin|TORQ_SENSOR_Pin|V_OUT_Pin|I_ROTOR_Pin;
...
void HAL_ADC_MspDeInit(ADC_HandleTypeDef* hadc)
{
  ...
  /* USER CODE END ADC1_MspDeInit 0 */
    ...
    PA5     ------> ADC1_IN10
    */
    HAL_GPIO_DeInit(GPIOA, I_STATOR_Pin|TORQ_SENSOR_Pin|V_OUT_Pin|I_ROTOR_Pin);
...
void HAL_QSPI_MspInit(QSPI_HandleTypeDef* hqspi)
{
  ...
  /* USER CODE END QUADSPI_MspInit 0 */
    ...
    */
    GPIO_InitStruct.Pin = QSPI_CLK_Pin|GPIO_PIN_11|QSPI_D0_Pin|QSPI_D1_Pin
...
void HAL_QSPI_MspDeInit(QSPI_HandleTypeDef* hqspi)
{
  ...
  /* USER CODE END QUADSPI_MspDeInit 0 */
    ...
    PE15     ------> QUADSPI_BK1_IO3
    */
    HAL_GPIO_DeInit(GPIOE, QSPI_CLK_Pin|GPIO_PIN_11|QSPI_D0_Pin|QSPI_D1_Pin
                          |QSPI_D2_Pin|QSPI_D3_Pin);
...
void HAL_TIM_MspPostInit(TIM_HandleTypeDef* htim)
{
  ...
  /* USER CODE END TIM17_MspPostInit 0 */
    ...
    PB7     ------> TIM17_CH1N
    */
    GPIO_InitStruct.Pin = ROTOR_PWM_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_AF_PP;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
    GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_VERY_HIGH;
    GPIO_InitStruct.Alternate = GPIO_AF14_TIM17;
    HAL_GPIO_Init(ROTOR_PWM_GPIO_Port, &GPIO_InitStruct);
